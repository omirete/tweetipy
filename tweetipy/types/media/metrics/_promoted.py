class PromotedMetrics():
    def __init__(self, playback_0_count: int = None, playback_100_count: int = None, playback_25_count: int = None, playback_50_count: int = None, playback_75_count: int = None, view_count: int = None) -> None:
